...
public class SnCal {
  ...
  private static String sk = "vxZGGVYz67o8LdvfVnS3q0GM7aGuCksG";
  private static String ak = "E3HkEgUsuKGrmd3TGKpSp1jl2197XL5p";
  ...
  public static void main(String[] args)
    ...
    // 此方法适用于get请求，如果是为发送post请求的url生成签名，
    // 请保证参数对按照key的字母顺序依次放入Map。以get请求为例：
    ...
    /**
     * http://api.map.baidu.com/location/ip?ip=192.168.1.107&ak=2T7PRTHgV7DAOq0sDz1jkHYZKR2uSDYI&sk=
     */
    Map paramsMap = new LinkedHashMap<String, String>();
    paramsMap.put("ak", ak);
//    paramsMap.put("ip", "192.168.1.107");
