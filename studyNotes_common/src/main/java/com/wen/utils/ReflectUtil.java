...
public class ReflectUtil {
   ...
   * 利用反射取值
   *
   * @param targetClass 要取值的calss
   * @param fieldName   要取得名称
   * @param value       要取得值bean
   * @return
   */
  public static Object getFieldValue(Class targetClass, String fieldName, Object value) {
    Field field = ReflectionUtils.findField(targetClass, fieldName, null);
